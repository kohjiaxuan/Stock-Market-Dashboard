...
def main(stock1, stock2, stock3, stock4, stock5, stock6, startdatetime=''):
    print('Retrieving stock takes 1 min due to max 5 API call per min, remove time.sleep(60.1) if using premium API account')
    stockdata = retrieve.stocks(stock1, stock2, stock3, stock4, stock5, stock6)
    print('Stock data has been successfully retrieved.')
    transformed_data = datas.transformdata(stockdata[0], stockdata[1], stockdata[2], stockdata[3], stockdata[4], stockdata[5], startdatetime)
    ...
    stocks_big.set_xlabel('Index for the Day: 20' + transformed_data["time"][0][0][0:8],fontsize=24)
...
if __name__ == "__main__":
    main('AAPL', 'AMZN', 'GOOGL', 'FB', 'MSFT', 'NFLX', '09:35')