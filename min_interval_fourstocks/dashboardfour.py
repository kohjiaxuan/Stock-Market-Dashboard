...
def main(stock1, stock2, stock3, stock4, startdatetime=''):
    stockdata = retrievefour.stocks(stock1, stock2, stock3, stock4)
    transformed_data = datasfour.transformdata(stockdata[0], stockdata[1], stockdata[2], stockdata[3], startdatetime)
    ...
    stocks_big.tick_params(axis='y', which='major', labelsize=24)
    stocks_big.tick_params(axis='x', which='major', labelsize=14)
    stocks_big.set_title('Relative Graph of Stock Price Index', fontsize=28)
    #Get datetime and add it to x label
    stocks_big.set_xlabel('Index for the Day: 20' + transformed_data["time"][0][0][0:8],fontsize=28)
    ...
    AAPLplot.legend(loc=legendjson['stockloc'][0], fontsize=14)
    ...
    AMZNplot.legend(loc=legendjson['stockloc'][1], fontsize=14)
    ...
    GOOGLplot.legend(loc=legendjson['stockloc'][2], fontsize=14)
    ...
    FBplot.legend(loc=legendjson['stockloc'][3], fontsize=14)
    ...
    jpg_name = 'Dashboard_'+str("20"+transformed_data["time"][0][0][0:8])+stocknames+'.jpg'
    pdf_name = 'Dashboard_'+str("20"+transformed_data["time"][0][0][0:8])+stocknames+'.pdf'
